...
class AbstractConverter(ABC):
    ...
    @classmethod
    @abstractmethod
    def from_obj(cls, dataclass: type[DataclassRichInstance | DataclassInstance], data: t.Any, **kwargs: t.Any) -> DataclassRichInstance:
        msg = (
    ...
    @classmethod
    @abstractmethod
    def as_obj(cls, dataclass_instance: DataclassRichInstance | DataclassInstance, **kwargs: t.Any) -> DataclassRichInstance:
        msg = (
